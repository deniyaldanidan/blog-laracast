<x-layout-main title="Edit Blog">
    <x-form formName="Edit Blog" formAction="" formMethod="POST" btnText="Submit">
        @method('PUT')
        <x-input-group id="title" label="blog Title" inputType="text" inputName="title"
            placeholder="Enter your blog title here" :value="$blog->title" />
        <x-input-group id="excerpt" label="blog excerpt" inputType="text" inputName="excerpt"
            placeholder="Enter your blog excerpt here" :value="$blog->excerpt" />
        <x-input-group id="body" label="blog body" inputType="text" inputName="body"
            placeholder="Enter your blog content here" :textArea="true" :value="$blog->body" />
